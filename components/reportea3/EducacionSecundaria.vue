    ...
    <div>
       <div style="height:12%;line-height:12px;text-align:center;display:table;width:100%;">
        <span style="display:table-cell;vertical-align: middle;text-align:center;">
            <b class="title">Educación Secundaria</b><br>
      ...
      <div style="height:88%;position:relative;">
        ...
        <CircularChart
            class="sub-container"
            :colors = colors
            ctitle="Ciencias Sociales (%)"
            style="width:50%;height:50%;float:left;"
            :distrito="getData(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Distrito' && obj.anno ==='2018'), 'hg_pest_sa')"
            :provincia="getData(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Provincia' && obj.anno ==='2018'), 'hg_pest_sa')"
            :departamento="getData(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Departamento' && obj.anno ==='2018'), 'hg_pest_sa')"
            :nacional="getData(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Nacional' && obj.anno ==='2018'), 'hg_pest_sa')"
            

           :ndistrito="getDataInt(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Distrito' && obj.anno ==='2018'), 'hg_nest_sa')"
          :nprovincia="getDataInt(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Provincia' && obj.anno ==='2018'), 'hg_nest_sa')"
          :ndepartamento="getDataInt(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Departamento' && obj.anno ==='2018'), 'hg_nest_sa')"
          :nnacional="getDataInt(reporteStore.results.ece_sec.filter((obj)=>obj.cat ==='Nacional' && obj.anno ==='2018'), 'hg_nest_sa')"
        ...
        class="sub-container"
        :colors = colors
        ctitle="Innovación y tecnología (%)"
        style="width:50%;height:50%;float:left;"
        categorie = 'two'
