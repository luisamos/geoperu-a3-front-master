...
echo "Carpeta /www-data/cem Eliminada"
rm -R ./dist
rm -R ./www-data/cem

echo "Creando espacio de trabajo 'www-data'"
mkdir -p ./www-data/cem
################################
echo "Reporte Cem ..."
echo "Estableciendo Configuración -> base [/cem]"
...
REPLACE_BASE="base: '/cem',"
REPLACE_STATIC="const STATIC_URL = '/cem/'"
...
cp ./pages/cem/_id.vue ./pages/_id.vue
cp ./pages/cem/index.vue ./pages/index.vue

echo "Generando..."
nuxt generate

echo "Moviendo a espacio de trabajo www-data"
mv ./dist/* ./www-data/cem
