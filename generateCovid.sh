...
echo "Carpeta /www-data/covid19 Eliminada"
rm -R ./dist
rm -R ./www-data/covid19

echo "Creando espacio de trabajo 'www-data'"
mkdir -p ./www-data/covid19
################################
echo "Reporte Principal ..."
echo "Estableciendo Configuración -> base [/covid19]"
...
REPLACE_BASE="base: '/covid19',"
REPLACE_STATIC="const STATIC_URL = '/covid19/'"
...
echo "Copiando covid19 a index"

cp ./pages/covid19/index.vue ./pages/index.vue

echo "Generando..."
nuxt generate

echo "Moviendo a espacio de trabajo www-data"
mv ./dist/* ./www-data/covid19
