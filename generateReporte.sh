...
echo "Carpeta /www-data/reporte Eliminada"
rm -R ./dist
rm -R ./www-data/reporte

echo "Creando espacio de trabajo 'www-data'"
mkdir -p ./www-data/reporte
################################
echo "Reporte Principal ..."
echo "Estableciendo Configuración -> base [/reporte]"
...
REPLACE_BASE="base: '/reporte',"
REPLACE_STATIC="const STATIC_URL = '/reporte/'"
...
cp ./pages/reporte/_id.vue ./pages/_id.vue
cp ./pages/reporte/index.vue ./pages/index.vue

echo "Generando..."
nuxt generate

echo "Moviendo a espacio de trabajo www-data"
mv ./dist/* ./www-data/reporte
