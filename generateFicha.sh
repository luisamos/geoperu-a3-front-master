...
echo "Carpeta /www-data/ficha Eliminada"
rm -R ./dist
rm -R ./www-data/ficha

echo "Creando espacio de trabajo 'www-data'"
mkdir -p ./www-data/ficha
################################
echo "Reporte Principal ..."
echo "Estableciendo Configuración -> base [/ficha]"
...
REPLACE_BASE="base: '/ficha',"
REPLACE_STATIC="const STATIC_URL = '/ficha/'"
...
echo "Copiando ficha a index"

cp ./pages/ficha/index.vue ./pages/index.vue

echo "Generando..."
nuxt generate

echo "Moviendo a espacio de trabajo www-data"
mv ./dist/* ./www-data/ficha
